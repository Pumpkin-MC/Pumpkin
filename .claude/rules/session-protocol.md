...
1. Every file in `logs/{today}/`
2. The last 5 files in `logs/{yesterday}/`
3. `logs/decisions/{your-agent}.md`
4. `logs/decisions/architect.md`
...
- Write ONLY to `logs/` (always allowed)
...
1. Write your session log: `logs/{today}/{seq}_{agent}_{description}.md`
2. Follow the log format in ORCHESTRATOR.md exactly — every section matters
3. Update `logs/decisions/{agent}.md` if you made any decisions
