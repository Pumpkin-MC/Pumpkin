...
mod tests {
    ...
    #[test]
    fn remaps_spawn_egg_related_item_ids_for_1_21_7() {
        assert_eq!(
            remap_item_id_for_version(Item::CAULDRON.id, MinecraftVersion::V_1_21_7),
            1082
        );
        assert_eq!(
            remap_item_id_for_version(Item::PIG_SPAWN_EGG.id, MinecraftVersion::V_1_21_7),
            1127
        );
        assert_eq!(
            remap_item_id_for_version(
                Item::PUFFERFISH_SPAWN_EGG.id,
    ...
    #[test]
    fn remaps_spawn_egg_related_item_ids_for_1_21_9() {
        assert_eq!(
            remap_item_id_for_version(Item::CAULDRON.id, MinecraftVersion::V_1_21_9),
            1127
        );
        assert_eq!(
            remap_item_id_for_version(Item::PIG_SPAWN_EGG.id, MinecraftVersion::V_1_21_9),
            1173
        );
        assert_eq!(
            remap_item_id_for_version(
    ...
    #[test]
    fn remaps_spawn_egg_related_item_ids_from_1_21_7() {
        assert_eq!(
            remap_item_id_from_version(1127, MinecraftVersion::V_1_21_7),
            Item::PIG_SPAWN_EGG.id
        );
        assert_eq!(
            remap_item_id_from_version(1132, MinecraftVersion::V_1_21_7),
            Item::PUFFERFISH_SPAWN_EGG.id
        );
    }

    #[test]
    fn remaps_spawn_egg_related_item_ids_from_1_21_9() {
        assert_eq!(
            remap_item_id_from_version(1173, MinecraftVersion::V_1_21_9),
            Item::PIG_SPAWN_EGG.id
        );
        assert_eq!(
            remap_item_id_from_version(1178, MinecraftVersion::V_1_21_9),
            Item::PUFFERFISH_SPAWN_EGG.id
        );
    }
}
