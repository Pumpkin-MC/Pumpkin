...
/// Mapping file from the server data version (26.2) up to the newer 26.3 client, generated by
/// `tools/forward-mappings/generate.py` from the vanilla data reports.
