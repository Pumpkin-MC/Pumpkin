...
/// Computes the inverse of an item stack ID mapping table, mapping new IDs back to old IDs.
///
/// # Arguments
...
/// Generates the `TokenStream` for per-version item stack ID remap tables and the
