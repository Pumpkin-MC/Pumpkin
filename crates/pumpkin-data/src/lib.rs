...
/// Embedded vanilla datapack resources (tags, recipes, advancements, loot tables)
/// generated by `pumpkin-codegen` and compiled into the binary.
/// Used by `pumpkin-datapack`'s `VanillaPackResources` in both dev and release builds.
#[rustfmt::skip]
