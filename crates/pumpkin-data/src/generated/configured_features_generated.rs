...
-> std::collections::HashMap<pumpkin_data::configured_feature::ConfiguredFeature, ConfiguredFeature>
{
    ...
    map.insert(
        ...
        ConfiguredFeature::Geode(Box::new(GeodeFeature {
            ...
            outer_wall_distance: IntProviderValue::new(UniformIntProvider {
                min_inclusive: 4i32,
                max_inclusive: 6i32,
            }),
            distribution_points: IntProviderValue::constant(0),
            point_offset: IntProviderValue::constant(0),
        ...
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            ...
            trunk_placer: TrunkPlacer {
                ...
                r#type: TrunkType::Bending(BendingTrunkPlacer {
                    ...
                    bend_length: IntProviderValue::new(UniformIntProvider {
                        min_inclusive: 1i32,
                        max_inclusive: 2i32,
                    }),
                }),
            ...
            foliage_placer: FoliagePlacer {
                radius: IntProviderValue::constant(3i32),
                offset: IntProviderValue::constant(0i32),
                r#type: FoliageType::RandomSpread(RandomSpreadFoliagePlacer {
                    foliage_height: IntProviderValue::constant(2i32),
    ...
    map.insert(
        ...
        ConfiguredFeature::NetherrackReplaceBlobs(ReplaceBlobsFeature {
            ...
            radius: IntProviderValue::new(UniformIntProvider {
                min_inclusive: 3i32,
                max_inclusive: 7i32,
            }),
        }),
    ...
    map.insert(
        ...
        ConfiguredFeature::BlockColumn(BlockColumnFeature {
            layers: vec![
                Layer {
                    height: IntProviderValue::new(BiasedToBottomIntProvider {
                        min_inclusive: 1i32,
                        max_inclusive: 3i32,
                    }),
                ...
                Layer {
                    height: IntProviderValue::new(WeightedListIntProvider {
                        distribution: vec![
                            WeightedEntry {
            ...
            layers: vec![
                Layer {
                    height: IntProviderValue::new(WeightedListIntProvider {
                        distribution: vec![
                            WeightedEntry {
                                data: IntProviderValue::new(UniformIntProvider {
                                    min_inclusive: 0i32,
                                    max_inclusive: 19i32,
                                }),
                                weight: 2i32,
                ...
                Layer {
                    height: IntProviderValue::constant(1i32),
                    provider: BlockStateProvider::RandomizedInt(RandomizedIntBlockStateProvider {
                        ...
                        values: IntProviderValue::new(UniformIntProvider {
                            min_inclusive: 23i32,
                            max_inclusive: 25i32,
                        }),
                    }),
        ...
        ConfiguredFeature::WaterloggedVegetationPatch(
            waterlogged_vegetation_patch::WaterloggedVegetationPatchFeature {
                base: vegetation_patch::VegetationPatchFeature {
                    ...
                    depth: IntProviderValue::constant(3i32),
                    extra_bottom_block_chance: 0.8f32,
                    vertical_range: 5i32,
                    vegetation_chance: 0.1f32,
                    xz_radius: IntProviderValue::new(UniformIntProvider {
                        min_inclusive: 4i32,
                        max_inclusive: 7i32,
                    }),
    ...
    map.insert(
        ...
        ConfiguredFeature::BasaltColumns(
            crate::generation::feature::features::basalt_columns::BasaltColumnsFeature {
                height: IntProviderValue::new(UniformIntProvider {
                    min_inclusive: 5i32,
                    max_inclusive: 10i32,
                }),
                reach: IntProviderValue::new(UniformIntProvider {
                    min_inclusive: 2i32,
                    max_inclusive: 3i32,
                }),
            },
    ...
    map.insert(
        ...
        ConfiguredFeature::VegetationPatch(vegetation_patch::VegetationPatchFeature {
            ...
            surface: pumpkin_util::math::vertical_surface_type::VerticalSurfaceType::Floor,
            depth: IntProviderValue::constant(1i32),
    ...
    map.insert(
        ...
        ConfiguredFeature::VegetationPatch(vegetation_patch::VegetationPatchFeature {
            ...
            depth: IntProviderValue::new(UniformIntProvider {
                min_inclusive: 1i32,
                max_inclusive: 2i32,
            }),
            extra_bottom_block_chance: 0f32,
    ...
    map.insert(
        ...
        ConfiguredFeature::SculkPatch(
            crate::generation::feature::features::sculk_patch::SculkPatchFeature {
                ...
                growth_rounds: 0i32,
                spread_rounds: 1i32,
                extra_rare_growths: IntProviderValue::new(UniformIntProvider {
                    min_inclusive: 1i32,
                    max_inclusive: 3i32,
                }),
    ...
    map.insert(
        ...
        ConfiguredFeature::SculkPatch(
            crate::generation::feature::features::sculk_patch::SculkPatchFeature {
                ...
                growth_rounds: 0i32,
                spread_rounds: 1i32,
                extra_rare_growths: IntProviderValue::constant(0i32),
                catalyst_chance: 0.5f32,
            },
        ),
    );
    ...
    map.insert(
        ...
        ConfiguredFeature::BasaltColumns(
            crate::generation::feature::features::basalt_columns::BasaltColumnsFeature {
                ...
                reach: IntProviderValue::constant(1i32),
            },
        ),
    );
    map.insert(
