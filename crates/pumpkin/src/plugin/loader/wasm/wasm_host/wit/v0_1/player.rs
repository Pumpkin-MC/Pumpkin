...
const fn to_wasm_java_version(
    ...
    match version {
        ...
        // TODO The plugin WIT has no 26.3 variant yet, report the closest one
        JavaMinecraftVersion::V_26_2 | JavaMinecraftVersion::V_26_3 => {
            pumpkin::plugin::player::JavaMinecraftVersion::V262
        }
