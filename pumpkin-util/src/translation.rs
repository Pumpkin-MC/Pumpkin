...
impl ToTokens for Locale {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        tokens.extend(match self {
            Locale::AfZa => quote!(Locale::AfZa),
            Locale::ArSa => quote!(Locale::ArSa),
            Locale::AstEs => quote!(Locale::AstEs),
            Locale::AzAz => quote!(Locale::AzAz),
            Locale::BaRu => quote!(Locale::BaRu),
            Locale::Bar => quote!(Locale::Bar),
            Locale::BeBy => quote!(Locale::BeBy),
            Locale::BgBg => quote!(Locale::BgBg),
            Locale::BrFr => quote!(Locale::BrFr),
            Locale::Brb => quote!(Locale::Brb),
            Locale::BsBa => quote!(Locale::BsBa),
            Locale::CaEs => quote!(Locale::CaEs),
            Locale::CsCz => quote!(Locale::CsCz),
            Locale::CyGb => quote!(Locale::CyGb),
            Locale::DaDk => quote!(Locale::DaDk),
            Locale::DeAt => quote!(Locale::DeAt),
            Locale::DeCh => quote!(Locale::DeCh),
            Locale::DeDe => quote!(Locale::DeDe),
            Locale::ElGr => quote!(Locale::ElGr),
            Locale::EnAu => quote!(Locale::EnAu),
            Locale::EnCa => quote!(Locale::EnCa),
            Locale::EnGb => quote!(Locale::EnGb),
            Locale::EnNz => quote!(Locale::EnNz),
            Locale::EnPt => quote!(Locale::EnPt),
            Locale::EnUd => quote!(Locale::EnUd),
            Locale::EnUs => quote!(Locale::EnUs),
            Locale::Enp => quote!(Locale::Enp),
            Locale::Enws => quote!(Locale::Enws),
            Locale::EoUy => quote!(Locale::EoUy),
            Locale::EsAr => quote!(Locale::EsAr),
            Locale::EsCl => quote!(Locale::EsCl),
            Locale::EsEc => quote!(Locale::EsEc),
            Locale::EsEs => quote!(Locale::EsEs),
            Locale::EsMx => quote!(Locale::EsMx),
            Locale::EsUy => quote!(Locale::EsUy),
            Locale::EsVe => quote!(Locale::EsVe),
            Locale::Esan => quote!(Locale::Esan),
            Locale::EtEe => quote!(Locale::EtEe),
            Locale::EuEs => quote!(Locale::EuEs),
            Locale::FaIr => quote!(Locale::FaIr),
            Locale::FiFi => quote!(Locale::FiFi),
            Locale::FilPh => quote!(Locale::FilPh),
            Locale::FoFo => quote!(Locale::FoFo),
            Locale::FrCa => quote!(Locale::FrCa),
            Locale::FrFr => quote!(Locale::FrFr),
            Locale::FraDe => quote!(Locale::FraDe),
            Locale::FurIt => quote!(Locale::FurIt),
            Locale::FyNl => quote!(Locale::FyNl),
            Locale::GaIe => quote!(Locale::GaIe),
            Locale::GdGb => quote!(Locale::GdGb),
            Locale::GlEs => quote!(Locale::GlEs),
            Locale::HawUs => quote!(Locale::HawUs),
            Locale::HeIl => quote!(Locale::HeIl),
            Locale::HiIn => quote!(Locale::HiIn),
            Locale::HrHr => quote!(Locale::HrHr),
            Locale::HuHu => quote!(Locale::HuHu),
            Locale::HyAm => quote!(Locale::HyAm),
            Locale::IdId => quote!(Locale::IdId),
            Locale::IgNg => quote!(Locale::IgNg),
            Locale::IoEn => quote!(Locale::IoEn),
            Locale::IsIs => quote!(Locale::IsIs),
            Locale::Isv => quote!(Locale::Isv),
            Locale::ItIt => quote!(Locale::ItIt),
            Locale::JaJp => quote!(Locale::JaJp),
            Locale::JboEn => quote!(Locale::JboEn),
            Locale::KaGe => quote!(Locale::KaGe),
            Locale::KkKz => quote!(Locale::KkKz),
            Locale::KnIn => quote!(Locale::KnIn),
            Locale::KoKr => quote!(Locale::KoKr),
            Locale::Ksh => quote!(Locale::Ksh),
            Locale::KwGb => quote!(Locale::KwGb),
            Locale::LaLa => quote!(Locale::LaLa),
            Locale::LbLu => quote!(Locale::LbLu),
            Locale::LiLi => quote!(Locale::LiLi),
            Locale::Lmo => quote!(Locale::Lmo),
            Locale::LoLa => quote!(Locale::LoLa),
            Locale::LolUs => quote!(Locale::LolUs),
            Locale::LtLt => quote!(Locale::LtLt),
            Locale::LvLv => quote!(Locale::LvLv),
            Locale::Lzh => quote!(Locale::Lzh),
            Locale::MkMk => quote!(Locale::MkMk),
            Locale::MnMn => quote!(Locale::MnMn),
            Locale::MsMy => quote!(Locale::MsMy),
            Locale::MtMt => quote!(Locale::MtMt),
            Locale::Nah => quote!(Locale::Nah),
            Locale::NdsDe => quote!(Locale::NdsDe),
            Locale::NlBe => quote!(Locale::NlBe),
            Locale::NlNl => quote!(Locale::NlNl),
            Locale::NnNo => quote!(Locale::NnNo),
            Locale::NoNo => quote!(Locale::NoNo),
            Locale::OcFr => quote!(Locale::OcFr),
            Locale::Ovd => quote!(Locale::Ovd),
            Locale::PlPl => quote!(Locale::PlPl),
            Locale::PtBr => quote!(Locale::PtBr),
            Locale::PtPt => quote!(Locale::PtPt),
            Locale::QyaAa => quote!(Locale::QyaAa),
            Locale::RoRo => quote!(Locale::RoRo),
            Locale::Rpr => quote!(Locale::Rpr),
            Locale::RuRu => quote!(Locale::RuRu),
            Locale::RyUa => quote!(Locale::RyUa),
            Locale::SahSah => quote!(Locale::SahSah),
            Locale::SeNo => quote!(Locale::SeNo),
            Locale::SkSk => quote!(Locale::SkSk),
            Locale::SlSi => quote!(Locale::SlSi),
            Locale::SoSo => quote!(Locale::SoSo),
            Locale::SqAl => quote!(Locale::SqAl),
            Locale::SrCs => quote!(Locale::SrCs),
            Locale::SrSp => quote!(Locale::SrSp),
            Locale::SvSe => quote!(Locale::SvSe),
            Locale::Sxu => quote!(Locale::Sxu),
            Locale::Szl => quote!(Locale::Szl),
            Locale::TaIn => quote!(Locale::TaIn),
            Locale::ThTh => quote!(Locale::ThTh),
            Locale::TlPh => quote!(Locale::TlPh),
            Locale::TlhAa => quote!(Locale::TlhAa),
            Locale::Tok => quote!(Locale::Tok),
            Locale::TrTr => quote!(Locale::TrTr),
            Locale::TtRu => quote!(Locale::TtRu),
            Locale::UkUa => quote!(Locale::UkUa),
            Locale::ValEs => quote!(Locale::ValEs),
            Locale::VecIt => quote!(Locale::VecIt),
            Locale::ViVn => quote!(Locale::ViVn),
            Locale::YiDe => quote!(Locale::YiDe),
            Locale::YoNg => quote!(Locale::YoNg),
            Locale::ZhCn => quote!(Locale::ZhCn),
            Locale::ZhHk => quote!(Locale::ZhHk),
            Locale::ZhTw => quote!(Locale::ZhTw),
            Locale::ZlmArab => quote!(Locale::ZlmArab),
        });
    }
}
