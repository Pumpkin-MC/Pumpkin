...
// Vanilla 26.2 ActivatorRailBlock (CFR):
...
impl BlockBehaviour for ActivatorRailBlock {
    ...
    fn on_neighbor_update<'a>(&'a self, args: OnNeighborUpdateArgs<'a>) -> BlockFuture<'a, ()> {
        Box::pin(async move {
            ...
            // Vanilla BaseRailBlock.neighborChanged → ActivatorRailBlock.updateState(self only).
...
impl ActivatorRailBlock {
    ...
    /// Vanilla `ActivatorRailBlock.updateState` — only this rail.
