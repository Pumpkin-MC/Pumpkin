...
/// Warden — GoalSelector stand-in until full vibration brain exists.
///
/// - Melee chase + sonic boom at mid range
/// - Revenge + nearest player without LOS (hearing)
/// - Periodic crude hearing of nearby players
...
impl WardenEntity {
    pub fn new(entity: Entity) -> Arc<Self> {
...

        {
            ...
            // Sonic boom when not in melee.
            goal_selector.add_goal(1, SonicBoomGoal::new());
