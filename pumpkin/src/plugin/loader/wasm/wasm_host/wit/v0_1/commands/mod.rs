...
pub(crate) const fn map_util_locale_to_wit(locale: I18nLocale) -> Locale {
    match locale {
        ...
        I18nLocale::BeLatn => Locale::BeLatn,
        ...
        I18nLocale::GoFr => Locale::GoFr,
        I18nLocale::HalUa => Locale::HalUa,
        I18nLocale::HawUs => Locale::HawUs,
        I18nLocale::HeIl => Locale::HeIl,
        I18nLocale::HiIn => Locale::HiIn,
        I18nLocale::HnNo => Locale::HnNo,
        ...
        I18nLocale::Pls => Locale::Pls,
        I18nLocale::PtBr => Locale::PtBr,
        I18nLocale::PtPt => Locale::PtPt,
        I18nLocale::QcbEs => Locale::QcbEs,
        I18nLocale::Qid => Locale::Qid,
        ...
        // Fall back to EnUs for any locale variant that is not yet
        // represented in the WIT binding (future additions).
        _ => Locale::EnUs,
    }
}
