use crate::plugin::{
    loader::wasm::wasm_host::{
        ...
        wit::v0_2_0::{
            events::{ToFromV0_2_0WasmEvent, consume_text_component},
...
impl ToFromV0_2_0WasmEvent for ServerCommandEvent {
...
impl ToFromV0_2_0WasmEvent for ServerBroadcastEvent {
