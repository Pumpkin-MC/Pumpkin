use crate::plugin::{
    ...
    loader::wasm::wasm_host::{
        ...
        wit::v0_2_0::{
            events::{
                ToFromV0_2_0WasmEvent, consume_player, consume_world, from_wasm_block_name,
...
impl ToFromV0_2_0WasmEvent for BlockRedstoneEvent {
...
impl ToFromV0_2_0WasmEvent for BlockBreakEvent {
    fn to_v0_2_0_wasm_event(&self, state: &mut PluginHostState) -> Event {
...
impl ToFromV0_2_0WasmEvent for BlockBurnEvent {
    fn to_v0_2_0_wasm_event(&self, _state: &mut PluginHostState) -> Event {
    ...
    fn from_v0_2_0_wasm_event(event: Event, _state: &mut PluginHostState) -> Self {
        match event {
...
impl ToFromV0_2_0WasmEvent for BlockCanBuildEvent {
    fn to_v0_2_0_wasm_event(&self, state: &mut PluginHostState) -> Event {
        let player = state
...
impl ToFromV0_2_0WasmEvent for BlockGrowEvent {
    fn to_v0_2_0_wasm_event(&self, state: &mut PluginHostState) -> Event {
        let target_world = state
            .add_world(self.world.clone())
            .expect("failed to add world resource");
...
impl ToFromV0_2_0WasmEvent for BlockPlaceEvent {
    fn to_v0_2_0_wasm_event(&self, state: &mut PluginHostState) -> Event {
        let player = state
            .add_player(self.player.clone())
            .expect("failed to add player resource");
