    ...
    loader::wasm::wasm_host::{
        ...
        wit::v0_1_0::{
            events::{
                ...
                from_wasm_entity_type_name, from_wasm_game_mode, from_wasm_hand,
                from_wasm_position, to_wasm_entity_type_name, to_wasm_game_mode, to_wasm_hand,
                to_wasm_position,
            },
...
impl ToFromV0_1_0WasmEvent for PlayerEggThrowEvent {
    fn to_v0_1_0_wasm_event(&self, state: &mut PluginHostState) -> Event {
        ...
        Event::PlayerEggThrowEvent(PlayerEggThrowEventData {
            ...
            hatching_type: to_wasm_entity_type_name(self.hatching_type),
            cancelled: self.cancelled,
        })
    }
    ...
    fn from_v0_1_0_wasm_event(event: Event, state: &mut PluginHostState) -> Self {
        match event {
            Event::PlayerEggThrowEvent(data) => Self {
                ...
                hatching_type: from_wasm_entity_type_name(&data.hatching_type),
                cancelled: data.cancelled,
            },
            _ => panic!("unexpected event type"),
        }
