...
pub struct PlayerBucketFillEvent {
    /// The player who filled the bucket.
    pub player: Arc<Player>,

    /// The target block position.
    pub position: Vector3<f64>,

    /// The key of the block being clicked (e.g., "minecraft:water").
    pub block_key: String,

    /// The face that was interacted with.
    pub face: Option<BlockDirection>,

    /// The bucket item key produced (e.g., "minecraft:water_bucket").
...
impl PlayerEvent for PlayerBucketFillEvent {
