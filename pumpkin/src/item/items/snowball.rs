...
use crate::entity::projectile::{ThrownItemEntity, snowball::SnowballEntity};
...
impl ItemBehaviour for SnowBallItem {
    fn normal_use<'a>(
        ...
        Box::pin(async move {
            ...
            let mut snowball = SnowballEntity::new_shot(entity, &player.living_entity.entity).await;
            let yaw = player.living_entity.entity.yaw.load();
            let pitch = player.living_entity.entity.pitch.load();
            snowball.thrown.set_velocity_from(&player.living_entity.entity, pitch, yaw, 0.0, POWER, 1.0);
