...
fn lookup_attribute(name: &str) -> Option<Attributes> {
    ...
    match name {
        "armor" | "generic.armor" => Some(Attributes::ARMOR),
        "armor_toughness" | "generic.armor_toughness" => Some(Attributes::ARMOR_TOUGHNESS),
        "attack_damage" | "generic.attack_damage" => Some(Attributes::ATTACK_DAMAGE),
        "attack_knockback" | "generic.attack_knockback" => Some(Attributes::ATTACK_KNOCKBACK),
        "attack_speed" | "generic.attack_speed" => Some(Attributes::ATTACK_SPEED),
        ...
        "flying_speed" | "generic.flying_speed" => Some(Attributes::FLYING_SPEED),
        "follow_range" | "generic.follow_range" => Some(Attributes::FOLLOW_RANGE),
        "gravity" | "generic.gravity" => Some(Attributes::GRAVITY),
        "jump_strength" | "generic.jump_strength" => Some(Attributes::JUMP_STRENGTH),
        "knockback_resistance" | "generic.knockback_resistance" => {
            Some(Attributes::KNOCKBACK_RESISTANCE)
        }
        "luck" | "generic.luck" => Some(Attributes::LUCK),
        "max_absorption" | "generic.max_absorption" => Some(Attributes::MAX_ABSORPTION),
        "max_health" | "generic.max_health" => Some(Attributes::MAX_HEALTH),
        "mining_efficiency" => Some(Attributes::MINING_EFFICIENCY),
        "movement_efficiency" => Some(Attributes::MOVEMENT_EFFICIENCY),
        "movement_speed" | "generic.movement_speed" => Some(Attributes::MOVEMENT_SPEED),
        "oxygen_bonus" => Some(Attributes::OXYGEN_BONUS),
        "safe_fall_distance" => Some(Attributes::SAFE_FALL_DISTANCE),
        "scale" | "generic.scale" => Some(Attributes::SCALE),
        "sneaking_speed" => Some(Attributes::SNEAKING_SPEED),
        "spawn_reinforcements" => Some(Attributes::SPAWN_REINFORCEMENTS),
        "step_height" | "generic.step_height" => Some(Attributes::STEP_HEIGHT),
