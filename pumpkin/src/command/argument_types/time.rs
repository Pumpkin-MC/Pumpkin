...
pub const INVALID_UNIT_ERROR_TYPE: CommandErrorType<0> = CommandErrorType::new(translation::ARGUMENT_TIME_INVALID_UNIT);
pub const TICK_COUNT_TOO_LOW_ERROR_TYPE: CommandErrorType<0> = CommandErrorType::new(translation::ARGUMENT_TIME_TICK_COUNT_TOO_LOW);
...
mod test {
    use crate::command::{
        argument_types::{argument_type::ArgumentType, time::TimeArgumentType, time},
    ...
    fn parse_ticks() {
        ...
        assert_parse_err_reset!(&mut reader, TimeArgumentType::new(20), &time::TICK_COUNT_TOO_LOW_ERROR_TYPE);
        ...
        assert_parse_err_reset!(&mut reader, TimeArgumentType::new(150), &time::TICK_COUNT_TOO_LOW_ERROR_TYPE);
    }
    ...
    fn parse_other_units() {
        ...
        assert_parse_err_reset!(&mut reader, TimeArgumentType::any(), &time::TICK_COUNT_TOO_LOW_ERROR_TYPE);
        ...
        assert_parse_err_reset!(&mut reader, TimeArgumentType::any(), &time::INVALID_UNIT_ERROR_TYPE);
