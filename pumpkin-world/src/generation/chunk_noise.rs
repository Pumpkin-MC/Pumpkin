...
use crate::{block::WorldBlockState, generation::section_coords};
...
pub const STONE_BLOCK: WorldBlockState = block_state!("stone");
pub const LAVA_BLOCK: WorldBlockState = block_state!("lava");
pub const WATER_BLOCK: WorldBlockState = block_state!("water");
